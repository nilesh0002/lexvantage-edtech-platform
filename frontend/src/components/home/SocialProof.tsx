...
const testimonialsData: Testimonial[] = [
  {
    id: 1,
    name: "Aditya Vardhan",
    role: "LexVantage 2-Year Program Student",
    nlu: "NLSIU Bangalore",
  ...
  },
  {
    id: 2,
    name: "Kritika Sen",
    role: "LexVantage Elite Dropper Program",
    nlu: "NLU Delhi",
    rank: "AIR 18 (AILET 2025)",
    quote: "Weekly 1-on-1 strategy sessions with my NLU alumni mentor kept me sane. When my mock scores plateaued in October, they helped me restructure my analytical reasoning approach. The mentorship is unmatched.",
  ...
  },
  {
    ...
    quote: "What sets LexVantage apart is their absolute transparency. I received weekly logs detailing Rohan's mock performances and batch attendance. The small batch size meant the faculty truly knew Rohan's weaknesses.",
  ...
  },
  {
    id: 4,
    name: "Shreya Ghoshal",
    role: "LexVantage 1-Year Classroom Student",
    nlu: "WBNUJS Kolkata",
    rank: "AIR 41 (CLAT 2025)",
    quote: "The daily Current Affairs summarizer feed was a lifesaver. Instead of spending hours summarizing massive newspapers, I read LexVantage's high-yield bulletins and took their 10-minute daily GK tests.",
  ...
  },
  {
    ...
    nlu: "NLIU Bhopal",
    quote: "We were skeptical about online coaching, but the interactive doubt-solving portal was stellar. Diya could upload photo doubts at 11 PM and get high-quality explanation videos within 15 minutes. Splendid system.",
